...
class Settings:
    ...
    image_embed_model: str = os.getenv("IMAGE_EMBED_MODEL", "openclip/ViT-L-14")
    image_embed_dim: int = int(os.getenv("IMAGE_EMBED_DIM", "768"))
    image_embed_device: str = os.getenv("IMAGE_EMBED_DEVICE", "cpu")
    enable_image_captioning: bool = _get_bool("ENABLE_IMAGE_CAPTIONING", True)
    ...
    image_caption_use_small: bool = _get_bool("IMAGE_CAPTION_USE_SMALL", False)
    image_caption_device: str = os.getenv("IMAGE_CAPTION_DEVICE", "cpu")
    image_caption_max_tokens: int = int(os.getenv("IMAGE_CAPTION_MAX_TOKENS", "80"))
    ...
    image_keyword_max: int = int(os.getenv("IMAGE_KEYWORD_MAX", "16"))
    image_search_vector_weight: float = float(os.getenv("IMAGE_SEARCH_VECTOR_WEIGHT", "0.7"))
    image_search_text_weight: float = float(os.getenv("IMAGE_SEARCH_TEXT_WEIGHT", "0.3"))
